...
const LoginModal: FC = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      setFontSize(window.innerWidth >= 365 ? null : 13);
    };
          ...
          {clicked ? (
            <>
              <div className="flex mb-2 space-x-2 justify-center items-center">
                <GiArchiveRegister />
                <h3 className={`font-bold text-center text-xl ${fontSize ? '' : 'text-[13px]'}`}>
                  Register
                </h3>
                <GiArchiveRegister />
              </div>
            ...
            <>
              <div className="flex mb-2 space-x-2 justify-center items-center">
                <FaUnlock />
                <h3 className={`font-bold text-center text-2xl ${fontSize ? '' : 'text-[13px]'}`}>
                  Login
                </h3>
                <FaUnlock />
              </div>
              <form onSubmit={submitForm} className="flex flex-col space-y-3">
                <div className="relative">
                  <input
                    ...
                    style={{ fontSize: fontSize != null ? `${fontSize}px` : 'inherit' }}
                  />
